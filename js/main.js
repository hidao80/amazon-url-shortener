...
function urlShorten() {
    ...
    if (shortUrl) {
        copyToClipboard(shortUrl, keepaUrl, sakuraCheckerUrl)
...
async function copyToClipboard(text, keepaUrl, sakuraCheckerUrl) {
    try {
        ...
        + __.translate('Keepa URL; ') + '<a href="' + keepaUrl + '" target="_blank">' + keepaUrl + '</a><br>'
        + __.translate('Sakura checker URL; ') + '<a href="' + sakuraCheckerUrl + '" target="_blank">' + sakuraCheckerUrl + '</a>';
    } catch (error) {
